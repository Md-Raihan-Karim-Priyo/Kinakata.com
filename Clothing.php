...
<body style="background-color: #E5E3E0">
    <div class="container">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="bg-light">
          ...
          <div class="row p-3">
            ...
            <div class="col-12 col-md-12 col-lg-4">
              ...
              <a href="Clothing.html"class="btn w-100  btn-outline-dark mb-3 active">Clothing</a>
        ...
        <div class="My-banner container col-lg-12" style="background-image: url(images/ClothBanner.jpg); background-size: cover;">
          <p class="pStyle">Get the greatest deals available!!!!</p>
          <p class="pStyle">Get all the latest fashion in one place!!!</p>
        </div>
    ...
    <div class="MyCardContainer mt-5">
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/ClothShirt01.jpg" class="card-img-top"  style="max-height: 12rem;" alt="Shirt">
            <div class="card-body">
              <h5 class="card-title">Shirt </h5>
              <p class="card-text">1200 Tk</p>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/ClothShirt02.jpg" class="card-img-top"style="max-height: 12rem;"" alt="Polo Shirt">
            <div class="card-body">
         ...
         <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/Jeans.jpg" class="card-img-top"  style="max-height: 12rem;" alt="Jeans pant">
            <div class="card-body">
              <h5 class="card-title">Jeans Pant </h5>
              <p class="card-text">800 Tk</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/ClothBTSshirt.jpg" class="card-img-top"  style="max-height: 12rem;" alt="BTS Shirt">
            <div class="card-body">
              <h5 class="card-title">BTS Shirt</h5>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/ClothLungi.jpg" class="card-img-top" style="max-height: 12rem;" alt="Cloth Lungi">
            <div class="card-body">
              <h5 class="card-title">Cotton Lungi</h5>
         ...
         <div class="col-12 col-md-12 col-lg-4 pl-sm-5 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/ClothSaree.jpg" class="card-img-top" alt="Saree indian dress">
            <div class="card-body">
              <h5 class="card-title">Jamdani Saree </h5>
              <p class="card-text">2500 Tk</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5 ">
          <div class="card text-center border border-dark" style="width: 18rem;">
            <img src="images/ClothHoodie.jpg" class="card-img-top" style="max-height: 12rem;" alt="Cloth Hoodie">
            <div class="card-body">
              <h5 class="card-title">Dark Hoodie</h5>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/ClothMask.jpg" class="card-img-top" style="max-height: 12rem;" alt="Mask ">
            <div class="card-body">
              <h5 class="card-title">Fashionable Mask</h5>
              <p class="card-text">300 Tk</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
         ...
         <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/ClothSuit.jpg" class="card-img-top" style="max-height: 12rem;" alt="Complete Suit">
            <div class="card-body">
              <h5 class="card-title">Complete Suit</h5>
