...
<head>
    ...
    <title>Baby Goods Section</title>
...
<body style="background-color: #E5E3E0">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="bg-light">
          ...
          <div class="row p-3">
            ...
            <div class="col-12 col-md-12 col-lg-4">
              <a href="BabyGoods.html"class="btn w-100  btn-outline-dark mb-3 active">Baby Goods</a>
        ...
        <div class="My-banner container col-lg-12" style="background-image: url(images/BabyBannar02.jpg);">
    ...
    <div class="MyCardContainer mt-5">
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/BabyBed.jpg" class="card-img-top" alt="Bed for baby">
            <div class="card-body">
              <h5 class="card-title">Baby Bed </h5>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/BabyCart.jpg" class="card-img-top"style="max-height: 12rem;" alt="Carring cart for baby">
            <div class="card-body">
              <h5 class="card-title">Baby Cart </h5>
         ...
         <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/BabyCloth.jpg" class="card-img-top" alt="Baby Dress">
            <div class="card-body">
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/BabyDiapers.jpg" class="card-img-top"  style="max-height: 12rem;" alt="Baby Diapers">
            <div class="card-body">
              <h5 class="card-title">Diapers</h5>
              <p class="card-text">300 Tk Per packet</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/BabyFeeder.jpg" class="card-img-top" style="max-height: 12rem;" alt="Baby Feeder">
            <div class="card-body">
         ...
         <div class="col-12 col-md-12 col-lg-4 pl-sm-5 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/BabyLotion.jpg" class="card-img-top" style="max-height: 12rem;"  alt="baby lotion">
            <div class="card-body">
              <h5 class="card-title">Baby Lotion</h5>
              <p class="card-text">350 Tk</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5 ">
          <div class="card text-center border border-dark" style="width: 18rem;">
            <img src="images/BabyPampers.jpg" class="card-img-top" style="max-height: 12rem;" alt="Pampers for baby">
            <div class="card-body">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/BabyPowder.jpg" class="card-img-top" style="max-height: 12rem;" alt="Baby body powder">
            <div class="card-body">
              <h5 class="card-title">Baby Powder</h5>
              <p class="card-text">350 Tk</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
         ...
         <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/BabyWipes.jpg" class="card-img-top" style="max-height: 12rem;" alt="wipes">
            <div class="card-body">
              <h5 class="card-title">Baby Wipes</h5>
              <p class="card-text">50 Tk Per packet</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
          ...
          <div class="container py-5">
            <div class="row">
              <div class="col-lg-3 mb-3">
                  <a href="#" class="navbar-brand" style="font-weight: bolder;color:mediumturquoise;">
                    <img class="rounded-circle"
                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR70YABR-NUTfoGsqF_WSIBT7tGlfgjC4qEnw&usqp=CAU"
