...
<body style="background-color: #E5E3E0">
    <div class="container">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="bg-light">
          ...
          <div class="row p-3">
            <div class=" col-12 col-md-12 col-lg-4">
              ...
              <a href="Fruits.html"class="btn w-100 btn-outline-dark mb-3 active">Fruits</a>
        ...
        <div class="My-banner container col-lg-12 " style="background-image: url(images/Apples.jpg);">
          <p class="pStyle">Get the greatest deals available!!!!</p>
          <p class="pStyle">All Fruits 20% discount</p>
        </div>
    ...
    <div class="MyCardContainer mt-5">
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem; ">
            <img src="images/Apples.jpg" class="card-img-top" style=" " alt="Apples">
            <div class="card-body">
              <h5 class="card-title">Apples </h5>
              <p class="card-text">200 Tk Per Kg</p>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/FruitsBanana.jpg" class="card-img-top" style=" max-height : 12rem;" alt="Banana">
            <div class="card-body">
              <h5 class="card-title">Banana</h5>
              <p class="card-text">40 Tk Per 4 pieces</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
         ...
         <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/FruitsGuava.jpg" class="card-img-top" style=" max-height : 12rem;" alt="Guava">
            <div class="card-body">
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/FruitsJackfruit.jpg" class="card-img-top" alt="Jack Fruit">
            <div class="card-body">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/FruitsMango.jpg" class="card-img-top"  style="max-height : 11rem;" alt="Mango">
            <div class="card-body">
              <h5 class="card-title">Mango</h5>
              <p class="card-text">150 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
         ...
         <div class="col-12 col-md-12 col-lg-4 pl-sm-5 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/FruitsOrange.jpg" class="card-img-top" style="max-height : 11rem;" alt="oranges">
            <div class="card-body">
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5 ">
          <div class="card text-center border border-dark" style="width: 18rem;">
            <img src="images/FruitsPineapples.jpg" class="card-img-top" style="max-height : 11rem;" alt="Pineapples">
            <div class="card-body">
              <h5 class="card-title">Pineapples</h5>
              <p class="card-text">50 Tk Per Piece</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/FruitsGrape.jpg" class="card-img-top" style="max-height : 11rem;"  alt="Grape">
            <div class="card-body">
              <h5 class="card-title">Grape</h5>
              <p class="card-text">250 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
         ...
         <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/FruitsStrawberry.jpg" class="card-img-top"  style="max-height : 11rem;" alt="Strawberry">
            <div class="card-body">
              <h5 class="card-title">Strawberry</h5>
              <p class="card-text">350 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
