...
<body style="background-color: #E5E3E0">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="bg-light">
          ...
          <div class="row p-3">
            ...
            <div class="col-12 col-md-12 col-lg-4">
              <a href="DryFood.html"class="btn w-100 btn-outline-dark mb-3 active">Dry Food</a>
        ...
        <div class="My-banner container col-lg-12" style="background-image: url(images/RedLentil.jpg);">
          <p class="pStyle">Get the greatest deals available!!!!</p>
          <p class="pStyle">Pandemic  discount on all dry foods!!!</p>
        </div>
    ...
    <div class="MyCardContainer mt-5">
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/RedLentil.jpg" class="card-img-top" style="max-height: 12rem;" alt="Red Lentil">
            <div class="card-body">
              <h5 class="card-title">Red Lentil </h5>
              <p class="card-text">110 Tk Per Kg</p>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/DryRice.jpg" class="card-img-top"style="max-height: 12rem;" alt="Rice">
            <div class="card-body">
         ...
         <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/DryWheat.jpg" class="card-img-top" alt="Wheat">
            <div class="card-body">
              <h5 class="card-title">Wheat </h5>
              <p class="card-text">45 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/DryMuri.jpg" class="card-img-top" style="min-height: 12rem;" alt="Puffed Rice">
            <div class="card-body">
              <h5 class="card-title">Puffed Rice</h5>
              <p class="card-text">100 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/DryOats.jpg" class="card-img-top" style="max-height: 12rem;"alt="Oats">
            <div class="card-body">
         ...
         <div class="col-12 col-md-12 col-lg-4 pl-sm-5 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/DryAlmond.jpg" class="card-img-top" style="max-height: 12rem;" alt="Almond ">
            <div class="card-body">
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5 ">
          <div class="card text-center border border-dark" style="width: 18rem;">
            <img src="images/DryElaichi.jpg" class="card-img-top" style="max-height: 12rem;" alt="Elaichi">
            <div class="card-body">
              <h5 class="card-title">Elaichi</h5>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/DryGinger.jpg" class="card-img-top" style="min-height: 12rem;" alt="Ginger">
            <div class="card-body">
              <h5 class="card-title">Ginger</h5>
              <p class="card-text">3000 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
         ...
         <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/DryClove.jpg" class="card-img-top" style="max-height: 12rem;" alt="Clove">
            <div class="card-body">
          ...
          <div class="container py-5">
            <div class="row">
              <div class="col-lg-3 mb-3">
                  <a href="index" class="navbar-brand" style="font-weight: bolder;color:mediumturquoise;">
                    <img class="rounded-circle"
                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR70YABR-NUTfoGsqF_WSIBT7tGlfgjC4qEnw&usqp=CAU"
