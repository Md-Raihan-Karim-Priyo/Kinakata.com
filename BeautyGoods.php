...
<head>
    ...
    <title>Beauty Goods Section</title>
...
<body style="background-color: #E5E3E0">
    <div class="container">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="bg-light">
          ...
          <div class="row p-3">
            ...
            <div class="col-12 col-md-12 col-lg-4">
              ...
              <a href="BeautyGoods.html"class="btn w-100  btn-outline-dark mb-3 active">Beauty Goods</a>
        ...
        <div class="My-banner container col-lg-12"style="background-image: url(images/BeautyBannar.jpg);">
    ...
    <div class="MyCardContainer mt-5">
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/BeautyMakeupBox.jpg" class="card-img-top"style="max-height: 12rem;" alt=" makeup box">
            <div class="card-body">
              <h5 class="card-title">Makeup Box </h5>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/BeautyMakeupKit.jpg" class="card-img-top"style="max-height: 12rem;" alt="Makeup Kit">
            <div class="card-body">
              <h5 class="card-title">Lakme Makeup Kit </h5>
              <p class="card-text">4,000 Tk</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
         ...
         <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/BeautyMascara.jpg" class="card-img-top" style="max-height: 12rem;"alt="Mascara">
            <div class="card-body">
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/BeautyKajal.jpg" class="card-img-top" style="max-height: 12rem;" alt="Eye Kajal">
            <div class="card-body">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/BeautyLipGloss.jpg" class="card-img-top" style="max-height: 12rem;" alt="Lip Gloss">
            <div class="card-body">
         ...
         <div class="col-12 col-md-12 col-lg-4 pl-sm-5 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/BeautyLipStick.jpg" class="card-img-top"style="max-height: 12rem;" alt="Lip Stick">
            <div class="card-body">
              <h5 class="card-title">Lip Stick</h5>
              <p class="card-text">400 Tk</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5 ">
          <div class="card text-center border border-dark" style="width: 18rem;">
            <img src="images/BeautyCream.jpg" class="card-img-top" style="max-height: 12rem;" alt="Cream">
            <div class="card-body">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/BeautyLotion.jpg" class="card-img-top" style="max-height: 12rem;" alt="Lotion">
            <div class="card-body">
              <h5 class="card-title">Lotion</h5>
              <p class="card-text">375 Tk</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
         ...
         <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/BeautyRemover.jpg" class="card-img-top" style="max-height: 12rem;" alt="Remover">
            <div class="card-body">
              <h5 class="card-title">Makeup Remover</h5>
