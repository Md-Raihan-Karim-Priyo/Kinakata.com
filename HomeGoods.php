...
<head>
    ...
    <title>Home Goods Section</title>
...
<body style="background-color: #E5E3E0">
    <div class="container">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="bg-light">
          ...
          <div class="row p-3">
            ...
            <div class="col-12 col-md-12 col-lg-4">
              ...
              <a href="HomeGoods"class="btn w-100  btn-outline-dark mb-3 active">Home Goods</a>
        ...
        <div class="My-banner container col-lg-12"style="background-image: url(images/HomeBannar.jpg);">
    ...
    <div class="MyCardContainer mt-5">
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/HomeBedSheet.jpg" class="card-img-top" style="max-height: 12rem;"alt="Bed Sheet">
            <div class="card-body">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/HomeBlanket.jpg" class="card-img-top"style="min-height: 12rem;" alt="Blanket">
            <div class="card-body">
         ...
         <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/HomeCarpet.jpg" class="card-img-top"style="max-height: 12rem;" alt="Carpet">
            <div class="card-body">
              <h5 class="card-title">Carpet </h5>
              <p class="card-text">2,000 Tk</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/HomeCurtains.jpg" class="card-img-top" style="max-height: 12rem;"alt="Curtains">
            <div class="card-body">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/HomeNightStand.jpg" class="card-img-top" style="max-height: 12rem;" alt="Night Stand">
            <div class="card-body">
              <h5 class="card-title">Night Stand</h5>
              <p class="card-text">6,000 Tk</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
         ...
         <div class="col-12 col-md-12 col-lg-4 pl-sm-5 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/HomeTV.jpg" class="card-img-top" alt="TV">
            <div class="card-body">
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5 ">
          <div class="card text-center border border-dark" style="width: 18rem;">
            <img src="images/HomeFan.jpg" class="card-img-top" style="max-height: 12rem;" alt="Table Fan">
            <div class="card-body">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/HomeDrawer.jpg" class="card-img-top" style="max-height: 12rem;" alt="Drawer">
            <div class="card-body">
              <h5 class="card-title">RFL Drawer</h5>
              <p class="card-text">2,000 Tk</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
         ...
         <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/HomeRack.jpg" class="card-img-top" style="max-height: 12rem;" alt="Rack">
            <div class="card-body">
              <h5 class="card-title">RFL Rack</h5>
              <p class="card-text">1,000 Tk</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
