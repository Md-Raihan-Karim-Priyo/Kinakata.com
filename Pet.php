...
<body style="background-color: #E5E3E0">
    <div class="container">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="bg-light">
          ...
          <div class="row p-3">
            ...
            <div class="col-12 col-md-12 col-lg-4">
              ...
              <a href="Pet.html"class="btn w-100 btn-outline-dark mb-3 active">Pet</a>
        ...
        <div class="My-banner container col-lg-12" style="background-image: url(images/PetAccessories.jpg); background-size:contain;">
          <p class="pStyle">Get the greatest deals available!!!!</p>
          <p class="pStyle">All Pet Accessories available Here!!!</p>
        </div>
    ...
    <div class="MyCardContainer mt-5">
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/PetLeash.jpg" class="card-img-top" alt="Dog Leash">
            <div class="card-body">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/PetCollar.jpg" class="card-img-top"style="max-height: 12rem;" alt="Dog Collar">
            <div class="card-body">
              <h5 class="card-title">Dog Collar </h5>
              <p class="card-text">600 Tk</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
         ...
         <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/PetFoodBowl.jpg" class="card-img-top" style="max-height: 12rem;" alt="Dog Food Bowl">
            <div class="card-body">
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/PetFood.jpg" class="card-img-top"  style="max-height: 12rem;" alt="Dog Food">
            <div class="card-body">
              <h5 class="card-title">Dog Food</h5>
              <p class="card-text">500 Tk Per packet</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/PetCatToy.jpg" class="card-img-top" style="max-height: 12rem;" alt="Toy Mouse">
            <div class="card-body">
              <h5 class="card-title">Toy Mouse</h5>
              <p class="card-text">250 Tk</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
         ...
         <div class="col-12 col-md-12 col-lg-4 pl-sm-5 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/PetCatCollar.jpg" class="card-img-top" style="max-height: 12rem;" alt="Cat Collar">
            <div class="card-body">
              <h5 class="card-title">Cat Collar</h5>
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5 ">
          <div class="card text-center border border-dark" style="width: 18rem;">
            <img src="images/PetCatLiterBox.jpg" class="card-img-top" style="max-height: 12rem;" alt="Cat Liter Box">
            <div class="card-body">
              <h5 class="card-title">Cat Liter Box with sand</h5>
              <p class="card-text">1000 Tk</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/PetCatCage.jpg" class="card-img-top" style="min-height: 12rem;" alt="Cat Cage">
            <div class="card-body">
              <h5 class="card-title">Full Steel Cat Cage</h5>
              <p class="card-text">1500 Tk</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
         ...
         <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/PetBirdCage.jpg" class="card-img-top" style="max-height: 12rem;" alt="Pet Bird Cage">
            <div class="card-body">
              <h5 class="card-title">Full Steel Bird Cage</h5>
              <p class="card-text">900 Tk</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
