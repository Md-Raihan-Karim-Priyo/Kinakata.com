...
<body style="background-color: #E5E3E0">
    <div class="container">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="bg-light">
          ...
          <div class="row p-3">
            <div class=" col-12 col-md-12 col-lg-4">
              <a href="Fish.html"class="btn w-100 btn-outline-dark mb-3 active">Fish</a>
        ...
        <div class="My-banner container col-lg-12 " style="background-image: url(images/FishIlish.jpg);background-size: contain;">
          <p class="pStyle">Get the greatest deals available!!!!</p>
          <p class="pStyle">All Fishes 10% discount</p>
        </div>
    ...
    <div class="MyCardContainer mt-5">
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/FishIlish.jpg" class="card-img-top" style="max-height: 12rem;" alt="Isilsh Fish">
            <div class="card-body">
              <h5 class="card-title">Ilish Fish</h5>
              <p class="card-text">1000 Tk Per Kg</p>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/FishChital.jpg" class="card-img-top"style="max-height: 12rem;" alt="Chital Fish">
            <div class="card-body">
              <h5 class="card-title">Chital Fish </h5>
              <p class="card-text">1200 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
         ...
         <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/FishKatla.jpg" class="card-img-top" style="max-height: 12rem;" alt="Katla Fish">
            <div class="card-body">
              <h5 class="card-title">Katla Fish </h5>
              <p class="card-text">700 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/FishMagur.jpg" class="card-img-top" style="max-height: 12rem;" alt="Magur Fish">
            <div class="card-body">
              <h5 class="card-title">Magur Fish</h5>
              <p class="card-text">1200 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/FishPuti.jpg" class="card-img-top" style="max-height: 12rem;" alt="Puti">
            <div class="card-body">
              <h5 class="card-title">Puti Fish</h5>
              <p class="card-text">600 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
         ...
         <div class="col-12 col-md-12 col-lg-4 pl-sm-5 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/FishRui.jpg" class="card-img-top" style="max-height: 12rem;" alt="Rui Fish">
            <div class="card-body">
              <h5 class="card-title">Rui Fish</h5>
              <p class="card-text">600 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5 ">
          <div class="card text-center border border-dark" style="width: 18rem;">
            <img src="images/FishRupchada.jpg" class="card-img-top" style="max-height: 12rem;" alt="Rupchada Fish">
            <div class="card-body">
              <h5 class="card-title">Rupchada Fish</h5>
              <p class="card-text">1800 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/FishSalmon.jpg" class="card-img-top" style="max-height: 12rem;" alt="Salmon Fish">
            <div class="card-body">
              <h5 class="card-title">Salmon Fish</h5>
              <p class="card-text">2000 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
         ...
         <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/FishSrimp.jpg" class="card-img-top" style="max-height: 12rem;" alt="Srimp Fish">
            <div class="card-body">
              <h5 class="card-title">Shrimp Fish</h5>
              <p class="card-text">800 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        </div>
