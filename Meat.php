...
<body style="background-color: #E5E3E0">
    <div class="container">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="bg-light">
          ...
          <div class="row p-3">
            <div class=" col-12 col-md-12 col-lg-4">
              ...
              <a href="Meat.html"class="btn w-100 btn-outline-dark mb-3 active">Meat</a>
        ...
        <div class="My-banner container col-lg-12 " style="background-image: url(images/Mutton.jpg);">
          <p class="pStyle">Get the greatest deals available!!!!</p>
          <p class="pStyle">All Meats 20% discount</p>
        </div>
    ...
    <div class="MyCardContainer mt-5">
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            ...
            <div class="card-body">
              ...
              <p class="card-text">300 Tk Per Kg</p>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/Chicken.jpg" class="card-img-top"style="max-height: 12rem;"" alt="Chicken">
            <div class="card-body">
         ...
         <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/Mutton.jpg" class="card-img-top" alt="Beef">
            <div class="card-body">
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/Mutton.jpg" class="card-img-top" alt="Cammal">
            <div class="card-body">
              <h5 class="card-title">Cammal Meat</h5>
              <p class="card-text">300 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/Chicken.jpg" class="card-img-top" style="max-height: 12rem;" alt="Duck">
            <div class="card-body">
         ...
         <div class="col-12 col-md-12 col-lg-4 pl-sm-5 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/Mutton.jpg" class="card-img-top" alt="Sheep">
            <div class="card-body">
              <h5 class="card-title">Sheep Meat</h5>
              <p class="card-text">300 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
      ...
      <div class="row mb-5">
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5 ">
          <div class="card text-center border border-dark" style="width: 18rem;">
            <img src="images/Chicken.jpg" class="card-img-top" style="max-height: 12rem;" alt="Pegion">
            <div class="card-body">
              <h5 class="card-title">pegion Meat</h5>
              <p class="card-text">300 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
        ...
        <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/Chicken.jpg" class="card-img-top" style="max-height: 12rem;" alt="Duck">
            <div class="card-body">
              <h5 class="card-title">Turky Meat</h5>
              <p class="card-text">300 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
         ...
         <div class="col-12 col-md-12 col-lg-4 mb-5">
          <div class="card text-center  border border-dark" style="width: 18rem;">
            <img src="images/Chicken.jpg" class="card-img-top" style="max-height: 12rem;" alt="Duck">
            <div class="card-body">
              <h5 class="card-title">Swarn Meat</h5>
              <p class="card-text">300 Tk Per Kg</p>
              <a href="#" class="btn btn-dark">Add to My Cart</a>
            </div>
          </div>
